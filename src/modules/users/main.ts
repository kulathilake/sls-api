...
app.useAction({name:'User:Get',method:'GET',path:'/user',requiredPermissions:[]});
app.get('/',(req,res,next)=>{
    const query = req.query as {k?:string,v?:string|number|boolean, i?: string, from?: string, size?: number};
...
app.useAction({name:'User:Get',method:'GET',path:'/user/:id',requiredPermissions:[]});
app.get('/:id',(req,res)=>{
...
app.useAction({name:'User:CREATE',method:'POST',path:'/user',requiredPermissions:[]});
